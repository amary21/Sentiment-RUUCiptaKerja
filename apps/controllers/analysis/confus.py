...
def performance():
    ...
    print('TP_DB =', cl.true_positive)
    print('FP_DB =', cl.false_positive)
    print('FN_DB =', cl.false_negative)
    print('TN_DB =', cl.true_negative)
    accuracy = ((cl.true_positive + cl.true_negative)/(cl.true_positive +
                                                       cl.true_negative + cl.false_positive + cl.false_negative))*100
